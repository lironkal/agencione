        ...
        <section
          ...
          {/* Background decoration */}
              <motion.div
                        ...
                        style={{
                                    background: "radial-gradient(ellipse at 50% 50%, #0066FF15 0%, transparent 60%)",
                        }}
                      />
              ...
              <div className="mx-auto max-w-site px-5 md:px-8 relative z-10">
                {/* Header */}
                      <motion.div
                                ...
                                <p className="text-gray-500 text-lg max-w-xl mx-auto">
                                            Contactez-nous aujourd'hui et obtenez un audit gratuit de votre présence digitale.
                                </p>p>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
                        {contactOptions.map((option, i) => (
                            <motion.a
                                          ...
                                          >
                                          <div className="text-4xl mb-4">{option.icon}</div>div>
                                          <h3
                ...
                {/* Bottom tagline */}
                      <motion.p
                                ...
                                >
                                Premier audit offert · Pas d'engagement · Réponse sous 24h
                      </motion.p>motion.p>
              </div>div>
        </section>section>
      );
