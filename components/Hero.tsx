        ...
        <div className="max-w-4xl">
          ...
          >
            ...
            <span className="text-sm font-medium text-blue-600 tracking-wide">
              Studio de marketing digital - Geneve
            </span>
          </motion.div>
          ...
          >
            Strategie digitale, creation de contenu et publicite performance pour les marques qui veulent dominer leur marche.
          </motion.p>
          ...
          >
            {[
              ...
              { number: "98%", label: "Taux de retention" },
            ].map((stat, i) => (
